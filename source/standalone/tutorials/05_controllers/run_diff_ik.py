# Copyright (c) 2024-2024, The ORBIT Project Developers.
# All rights reserved.
#
...
.. code-block:: bash
    ...
    # Usage
    ./orbit.sh -p source/standalone/tutorials/06_controllers/ik_control.py
...
parser.add_argument("--num_envs", type=int, default=129, help="Number of environments to spawn.")
