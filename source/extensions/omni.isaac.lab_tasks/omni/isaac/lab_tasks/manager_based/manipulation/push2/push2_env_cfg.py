...
class EventCfg:
    ...
    reset_object1_position = EventTerm(
        ...
        mode="reset",
        params={
            "pose_range": {"x": (-0.1, -0.01), "y": (-0.25, -0.01), "z": (0.0, 0.0)},
            "velocity_range": {},
    ...
    reset_object2_position = EventTerm(
        ...
        mode="reset",
        params={
            "pose_range": {"x": (0.01, 0.1), "y": (0.01, 0.25), "z": (0.0, 0.0)},
            "velocity_range": {},
...
class RewardsCfg:
    ...
    block_1_hint = RewTerm(func=mdp.block_1_hint, weight=0.4)
    block_2_hint = RewTerm(func=mdp.block_2_hint, weight=0.4)
